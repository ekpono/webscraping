<template>
    <section class="">
        <div class="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
            ...
            <p class="text-3xl">No Book Found</p>
            <p><code class="dark:bg-gray-900 dark:text-gray-100">sail artisan book:scraper </code> <br> Please run the above command on your terminal to populate books here</p>
        </div>
    </section>
</template>
